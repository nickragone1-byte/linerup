    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      <div className="max-w-2xl mx-auto px-4 py-12">
        ...
        <p className="text-sm text-zinc-600 mb-10">
          Historical performance by tier — 2026 season
        </p>
        ...
        <div className="rounded-lg border border-zinc-800/60 bg-zinc-900/20 p-8 text-center">
          ...
          <p className="text-xs text-zinc-700 mt-2 max-w-xs mx-auto leading-relaxed">
            Full W-L tracking by tier launches once the results pipeline is connected. V8
            training accuracy is 57.09% on 7,619 historical games.
          </p>
        </div>
      </div>
    </div>
