    ...
    >
      ...
      <div
        ...
        style={{
          ...
          fontSize: 12, border: `1px solid ${clr}40`
        }}
      >
        {lbl}
      </div>
      ...
      <div className="shrink-0 text-right">
        <div
          ...
          style={{
            background: record.tier === "PLAY" ? "rgba(16,185,129,0.1)" : "rgba(234,179,8,0.1)",
            color: record.tier === "PLAY" ? "#10b981" : "#eab308",
            fontSize: 10
          }}
        >
          {record.tier}
      ...
      <div className="max-w-2xl mx-auto px-4 py-10">
        ...
        {totalGames > 0 ? (
          ...
          <div
            ...
            style={{ background
cat > /root/linerup/app/results/page.tsx << 'EOF'
import Link from "next/link";
import { getResults } from "@/lib/data";
import type { PickRecord } from "@/lib/types";
        ...
        {totalGames > 0 ? (
          ...
          >
            <p style={{ fontSize: 13, color: "#4a5568" }}>
              Results populate automatically after each day's games complete.
            </p>
            <p style={{ fontSize: 11, color: "#2a3a55", marginTop: 8 }}>
              Tracking started {mlbResults.tracking_start_date}
            </p>
          </div>
        )}
